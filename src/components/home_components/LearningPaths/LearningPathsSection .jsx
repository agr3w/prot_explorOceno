...
const paths = [
    { label: 'Quizzes', description: 'Teste seus conhecimentos de forma divertida.' },
    { label: 'Documentários', description: 'Assista e aprenda com conteúdos ricos.' },
    { label: 'Exploração', description: 'Descubra e interaja com o oceano.' },
];
